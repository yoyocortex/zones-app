 ...
 * Performance: Logs execution time for optimization monitoring
 *
 ...
 * Handles coordinate format conversion for all zone types
 * Turf uses [lng, lat] format (GeoJSON standard) vs Leaflet's [lat, lng]
 *
